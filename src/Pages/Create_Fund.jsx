...
const Create_Fund = () => {
    ...
    const handleGooglePay = () => {
        if (/Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(navigator.userAgent)) {
            window.location.href = `intent://pay?pa=${scannerData}&amp;am=${amount}&amp;cu=INR&amp;tn=${receipt}#Intent;scheme=upi;package=com.google.android.apps.nbu.paisa.user`;
        } else {
    ...
    const handlePhonePay = () => {
        if(/Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(navigator.userAgent)) {
            ...
            window.location.href = `intent://pay?pa=${scannerData}&amp;am=${amount}&amp;cu=INR&amp;tn=${receipt}#Intent;scheme=upi;package=com.phonepe.app`;
        } else {
    ...
    const handlePaytmPay = () => {
        if(/Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(navigator.userAgent)) {
            ...
            window.location.href = `intent://pay?pa=${scannerData}&amp;am=${amount}&amp;cu=INR&amp;tn=${receipt}#Intent;scheme=upi;package=net.one97.paytm;end`;
        } else {
    ...
    const handleUPI = () => {
        if (/Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(navigator.userAgent)) {
            window.location.href = `upi://pay?pa=${scannerData}&pn=demo2&tn=${receipt}&am=${amount}&cu=INR`;
        } else {
            window.location.href = `https://pay.google.com/gp/v/gpc?amount=${amount}`;
        }
    };
