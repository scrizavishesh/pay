            ...
            <div className="container-fluid">
                    ...
                    <div className="col-md-5">
                        <nav className="p-2" style={customStyle} aria-label="breadcrumb">
                            <ol className="breadcrumb">
                                ...
                                <li className="breadcrumb-item active" style={{ color: "#FF914D" }} aria-current="page">Create Sub Creator</li>
                            </ol>
                        </nav>
                    </div>
                </div>
                <div className="row"> {/* Corrected class to className */}
                    <div className="col-lg-12 col-md-12 col-12"> {/* Corrected class to className */}
                        <div className="mb-5">
                            <h3 className="mb-0">Create Sub User</h3> {/* Corrected class to className */}
                        </div>
                    </div>
                    <hr />
                </div>
                                ...
                                <form>
                                    ...
                                    <div className="mb-3 mt-3">
                                        ...
                                        <div className="form-check form-check-inline">
                                            ...
                                            />
                                            <label className="form-check-label" htmlFor="inlineRadio1">Sub Creator</label>
                                        </div>
